...
// you should use "ft_pchr" and "ft_pstr" functions from
...
int main()
{
    ...
    printf("=> (%d)\n", ft_printf(" %d %d %d %d %d %d %d %d %d %i \"\n",
                                42, -42, INT_MIN, INT_MAX, NULL, "TEST", "", LONG_MIN, LONG_MAX, ponter) - 2); ft_pchr('\n');
    
    ft_pstr("\n*-- %u --*\n");
    ft_pstr(".  printf: \"");
    printf("=> (%d)\n",    printf(" %u %u %u %u %u %u %u \"\n", INT_MIN, 2147483650, -1, NULL, ULONG_MAX, LONG_MAX, LLONG_MAX) - 2);
    ft_pstr("ft_printf: \"");
    printf("=> (%d)\n", ft_printf(" %u %u %u %u %u %u %u \"\n", INT_MIN, 2147483650, -1, NULL, ULONG_MAX, LONG_MAX, LLONG_MAX) - 2); ft_pchr('\n');

    ft_pstr("\n*-- %x --*\n");
    ft_pstr(".  printf: \"");
    printf("=> (%d)\n",    printf(" %x %x %x %x %x %x %x %x \"\n", NULL, INT_MIN, INT_MAX, 0, '0', LONG_MIN, LONG_MAX, LLONG_MAX) - 2);
    ft_pstr("ft_printf: \"");
    printf("=> (%d)\n", ft_printf(" %x %x %x %x %x %x %x %x \"\n", NULL, INT_MIN, INT_MAX, 0, '0', LONG_MIN, LONG_MAX, LLONG_MAX) - 2); ft_pchr('\n');
